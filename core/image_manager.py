...
class ImageManager:
    ...
    def normalize_coordinates(self, x1: float, y1: float, x2: float, y2: float) -> Tuple[float, float, float, float]:
    ...
    def denormalize_coordinates(self, x_center: float, y_center: float, width: float, height: float) -> Tuple[float, float, float, float]:
